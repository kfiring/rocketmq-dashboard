            ...
            for (BrokerData bd : topicRouteData.getBrokerDatas()) {
                ...
                if (masterAddr != null) {
                    try {
                        ...
                        log.info("Exception caught: mqAdminExt get broker stats data TOPIC_PUT_NUMS failed, topic [{}]", topic, e.getMessage());
                    }
                }
            }
                    ...
                    for (BrokerData bd : topicRouteData.getBrokerDatas()) {
                        ...
                        if (masterAddr != null) {
                            try {
                                ...
                                log.info("Exception caught: mqAdminExt get broker stats data GROUP_GET_NUMS failed, topic [{}], group [{}]", topic, group, e.getMessage());
                            }
                        }
                    }
                }
